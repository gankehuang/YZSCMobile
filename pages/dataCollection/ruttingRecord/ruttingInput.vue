<template>
	<view>
		...
		<view class="submits">
			<button type="primary" class="flexc other-btn" @click="jumpPage" data-key="单个录入" data-jumpurl="/pages/dataCollection/birthRecord/birthInputHy">生成后裔个体</button>
		</view>
		<view class="submits jus-b">
			<button type="primary" class="flexc add-btn">加入明细(3)</button>

	...
	<view>
		...
		<view class="status">
			...
			<view class="status-header">
				...
				<view class="more-icon" @click="showFilter">
			...
			<view class="status-search">
				<view class="search-wrap">
					...
					<view class="search-wrap-input">
						<input type="text" value="" placeholder="请输入刷选条件" />
					</view>
		...
		<mpvue-picker value=''  :themeColor="themeColor" ref="mpvuePicker" mode="dateSelector" @onConfirm="onConfirmDate" @onCancelDate="onCancel"
		 ></mpvue-picker>
		  <mpvue-picker :themeColor="themeColor" value='' ref="pigPicker" 
	...
	export default {
		...
		methods: {
			...
			rowTapHandler(row) {
				...
				url: `/pages/dataCollection/breedRecord/breedDetail?id=${row.id}`,
					success: res => {},
					fail: () => {},
					complete: () => {}
				});

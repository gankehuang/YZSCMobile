<template>
	<view>
		...
		<!-- btn -->
		<view class="submits">
			<button type="primary" class="flexc submit-btn" data-key="保存" data-jumpurl="/pages/ywcj_lowvalue/history">保存</button>
			<button type="primary" class="flexc editor-btn" data-key="编辑" data-jumpurl="/pages/ywcj_lowvalue/fledit">编辑</button>
		</view>
	</view>
</template>

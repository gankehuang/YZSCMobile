		...
		<view class="semen-editor">
			...
			<view class="card-form card ly">
				<view class="jus-j form-list">
					...
					<view class="s-value d-num">
						<input type="text" value="毛巾" placeholder="请输入" />
					</view>
				</view>
				<view class="jus-j form-list">
					<view class="field">
				...
				<view class="jus-j form-list">
					...
					<view class="s-value">
						<view class="s-value d-num">
							<input type="text" value="10" placeholder="请输入" />
						</view>
					</view>
				</view>
				<view class="jus-j form-list">
					...
					<view class="s-value">
						<view class="s-value d-num">
							<input type="text" value="20条/箱" placeholder="请输入" />
						</view>
					</view>
				</view>
				<view class="jus-j form-list">
					...
					<view class="s-value">
						<view class="s-value d-num">
							<input type="text" value="条" placeholder="请输入" />
						</view>
					</view>
				</view>
			</view>

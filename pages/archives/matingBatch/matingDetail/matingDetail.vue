<template>
	<view class="page-wrapper">
		...
		<view class="header-wrap">
			<swiper class="swiper" style="height: 200rpx;">
				<swiper-item>
					<view class="header-container" style="font-size: 14px;">
						<view class="header-row">
							<text>配种批次号：PZPC123541</text>
							<text>批次建立日期：2019/10/10</text>
						</view>
						<view class="header-row" style="margin-bottom: 25px;margin-top: 10px;">
							<text>启用状态：启用状态</text>
							<text>批次状态：批次状态</text>
						</view>
					</view>
		...
		<view class="radius_card_wrap" v-show="currentNavIndex == 0">
			<view class="card_row">
				...
				<view class="card_value">某某某分场</view>
			</view>
			<view class="card_row">
				<view class="card_label">批次配种类型</view>
				<view class="card_value">批次配种类型</view>
			</view>
			<view class="card_row">
				<view class="card_label">平均配种时间</view>
				<view class="card_value">2018/01/01</view>
			</view>
			<view class="card_row">
				<view class="card_label">平均分娩时间</view>
				<view class="card_value">2019/10/10</view>
			</view>
			<view class="card_row">
				<view class="card_label">平均预产期</view>
				<view class="card_value">2019/10/10</view>
			</view>
			<view class="card_row">
				<view class="card_label">配种开始时间</view>
				<view class="card_value">2019/10/10</view>
			</view>
			<view class="card_row">
				<view class="card_label">配种结束时间</view>
				<view class="card_value">2019/10/10</view>
			</view>
			<view class="card_row">
				<view class="card_label">分娩开始时间</view>
				<view class="card_value">2019/10/10</view>
			</view>
			<view class="card_row">
				<view class="card_label">分娩结束时间</view>
				<view class="card_value">2019/10/10</view>
			</view>
			<view class="card_row">

	...
	<view class="page-wrapper">
		...
		<view class="radius_card_wrap" style="padding-top: 15px; padding-left: 15px;margin-bottom: 65px;">
				<view class="card_row"  style="height: 47px;">
					<view class="card_label" style="color: #4785F3;">车辆信息</view>
				</view>
				<view class="card_row"  style="height: 47px;">
					...
					<view class="card_value">
						<input type="text" style="text-align: right;"  placeholder="赣G 31T21" />
					</view>
				</view>
				...
				<view class="card_row"  style="height: 47px;">
					...
					<view class="card_value">
						<input type="text" style="text-align: right;"  placeholder="外部拉猪车" />
					</view>
				</view>
			</view>

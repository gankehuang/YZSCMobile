	...
	<view>
		...
		<view class="health-container">
			...
			<view class="card-form card">
				...
				<uni-cell title="抽盘类型" :value="form.projectName"></uni-cell>
				<uni-cell title="盘点日期" required="true" :value="form.projectName"></uni-cell>
				<uni-cell title="猪场/分厂" :value="form.projectName"></uni-cell>
			</view>

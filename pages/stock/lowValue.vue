	...
	<view>
		...
		<view class="status">
			...
			<view class="status-header">
				...
				<view class="status-del"   @tap="seeFamily">
					操作记录
				</view>
			</view>
		</view>
		...
		<!-- <view class="health-container">
			...
			<view class="editor-title flex ali-c jus-b">
				...
				<view class="btn">
					<button type="primary" @click="jumpPage"  data-jumpurl="lowValueNew" >新增</button>
				</view>
			</view>

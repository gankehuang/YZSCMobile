	...
	<view>
		...
		<view class="health-container">
			<view class="card-form card">
				<uni-cell title="药品名称" :value="form.projectName"></uni-cell>
				<uni-cell title="计量单位" :value="form.projectName"></uni-cell>
				<uni-cell title="规格型号" :value="form.projectName"></uni-cell>
				<uni-cell title="批次号" required="true" :value="form.projectName"></uni-cell>
				<uni-cell title="库存数量" :value="form.projectName"></uni-cell>
				<uni-cell title="盘点数量" required="true" :value="form.projectName"></uni-cell>
				<uni-cell title="差异数量" :value="form.projectName"></uni-cell>
				<uni-cell title="生产日期" :value="form.projectName"></uni-cell>
				<uni-cell title="到期日期" :value="form.projectName"></uni-cell>
				<uni-cell title="基本分类" :value="form.projectName"></uni-cell>
			</view>

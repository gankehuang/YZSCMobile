<template>
	<view class="page-wrapper">
		...
		<view>
			...
			<view class="radius_card_wrap">
				<view class="card_row">
					<view class="card_label title">上市计划明细</view>
				</view>
				<view class="card_row">
					<view class="card_label">正品苗</view>
					<view>
						<input type="text" value="" placeholder="请输入" style="text-align: right;"/>
					</view>
				</view>
				...
				<view class="card_row">
					<view class="card_label">均重</view>
					<view>
						<input type="text" value="" placeholder="请输入" style="text-align: right;"/>
					</view>
				</view>
				<view class="card_row">
					<view class="card_label">次品苗</view>
					<view>
						<input type="text" value="" placeholder="请输入" style="text-align: right;"/>
					</view>
				</view>
			...
			<view class="radius_card_wrap">
				<view class="card_row">
					<view class="card_label title">猪苗去向</view>
				</view>
				<view class="card_row">

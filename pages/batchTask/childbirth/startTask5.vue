	...
	<view class="page-wrapper">
		...
		<view>
			<view class="radius_card_wrap">
				...
				<view class="card_row">
					<view class="card_label">哺乳批次</view>
			...
			<view class="radius_card_wrap">
				<view class="card_row">
					<view class="card_label title">淘汰明细</view>
				</view>
				<view class="card_row">
				...
				<view class="cardList">
					<view class="card_row" >
						<view class="row_title">哺乳天数</view>
						<view>自动带出</view>
					</view>
				</view>
				<view class="cardList">
					<view class="card_row" >
						<view class="row_title">当前胎次</view>
						<view>自动带出</view>
					</view>
				</view>
				<view class="cardList">
					<view class="card_row" >
						<view class="row_title">淘汰原因</view>
						<view>自动带出</view>
					</view>
				</view>
				<view class="card_row">
					<view class="card_label">重量</view>
					<view>
						<input type="text" value="" placeholder="请输入" style="text-align: right;"/>
					</view>
				</view>

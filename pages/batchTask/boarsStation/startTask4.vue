<template>
	<view class="page-wrapper">
		...
		<view>
			...
			<view class="radius_card_wrap">
				<view class="card_row">
					<view class="card_label title">效果明细</view>
				</view>
				<view class="card_row">
					<view class="card_label">发烧头数</view>
					<view>
						<input type="text" value="" placeholder="请输入" style="text-align: right;"/>
					</view>
				</view>
				...
				<view class="card_row">
					<view class="card_label">拉稀头数</view>
					<view>
						<input type="text" value="" placeholder="请输入" style="text-align: right;"/>
					</view>
				</view>
				...
				<view class="card_row">
					<view class="card_label">头均采食量</view>
					<view>
						<input type="text" value="" placeholder="请输入" style="text-align: right;"/>
					</view>
				</view>
				<view class="cardList">
					<view class="card_row" >
						<view class="row_title">下降占比</view>
						<view>自动带出%</view>
					</view>
				</view>
			</view>

					...
					<view class="main-wrap-contetnt-item">
						...
						<view class="main-wrap-contetnt-item-field" style="padding-top: 0;">
							...
							<view class="main-wrap-contetnt-item-field-value">
								<input type="text" placeholder="核心群调整/生产公猪调整" />
							</view>
						</view>
				...
				<view class="main-wrap-contetnt">
					<view class="main-wrap-contetnt-item">
						<view class="main-wrap-contetnt-item-title">
							<view class="main-wrap-contetnt-item-title-text" style="font-size: 14px;margin: 0;">等级/调整明细</view>
						</view>
						...
						<view class="main-wrap-contetnt-item-field">
							...
							<view class="main-wrap-contetnt-item-field-value">
								<input type="text" placeholder="核心群一级" />
							</view>
						</view>
						...
						<view class="main-wrap-contetnt-item-field">
							...
							<view class="main-wrap-contetnt-item-field-value">
								<input type="text" placeholder="生产公猪" />
							</view>
						</view>
						...
						<view class="main-wrap-contetnt-item-field">
							...
							<view class="main-wrap-contetnt-item-field-value">
								<input type="text" placeholder="精液少" />
							</view>
						</view>

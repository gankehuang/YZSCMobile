				...
				<view class="main">
					<view class="main-wrap" style="padding-top: 10rpx;">
						...
						<view class="editor-title flex ali-c" style="justify-content: space-between;">
							...
							<button type="primary"  class="new-btn" style="margin: 0;font-size: 10px;padding: 0 24px;" @click="jumpPage" data-key="明细" data-jumpurl="/pages/businessAdjustment/gradePig/gradePigEditor">新增</button>
						</view>
						<!-- 数据表格 -->
		...
		<script>
			...
			export default {
				...
				onLoad(e) {
					...
					uni.setStorageSync('URL', JSON.stringify([this.array[1][this.index],this.array1[1][this.index1],1]));  
				...
				methods: {
					add(){
						...
						console.log(params)
						common.commRequest(`/CtPigCoreGroupTypeAdjustBill/insertCtPigCoreGroupTypeAdjustBill`, params, headers,'post',
								function(data) {
									console.log(data)
